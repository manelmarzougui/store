...
function Desc() {
  const [liste, setliste] = useState([
    ...
    },
    {
      id: 8,
      name: "pull",
      url: "https://www.cdiscount.com/pdt2/5/2/6/1/300x300/mp51993526/rw/plume-de-couleur-unie-a-col-en-v-pour-femmes-evida.jpg",
      prix: "50dt",
    },
    {
      id: 9,
    ...
    },
    {
      id: 10,
      name: "botinne",
      url: "https://www.cdiscount.com/pdt2/8/9/6/1/300x300/mp53414896/rw/poche-pour-bottines-femme-noir.jpg",
      prix: "80dt",
    },
  ]);
  const params = useParams();
  const prod = liste.find((el) => el.id == params.id);
  return (
    <div>
      ...
      <div className="infooo">
        ...
        <div className="des">
          ...
          <p>
            ...
            felis enim. Pellentesque sed commodo enim, ac interdum purus. Cras
            euismod est ut turpis ultricies tincidunt
          </p>
          <h5>Taille: S M L XL XXL</h5>
          <h4>{prod.prix}</h4>
          <div className="ttt">
            <div className="but1">
              <Link to="/Boutique">
